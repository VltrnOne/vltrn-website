    ...
    <div className="relative">
      ...
      >
        {sections.map((section, index) => (
          <section
            key={section.id}
            className={`h-screen flex flex-col items-center justify-center text-center px-4 snap-start relative overflow-hidden`}
          >
            {/* Animated Background */}
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              <h1 className="text-8xl font-bold mb-6 tracking-tight text-white">
                {section.title}
              </h1>
